    ...
    return AppBar(
      ...
      actions: [
        inSearchMode
            ? IconButton(
                ...
                tooltip: context.translations.tooltips.close,
                onPressed: () => context
            ...
            : IconButton(
                ...
                tooltip: context.translations.tooltips.search,
                onPressed: () => context
                    .read<ScheduleListBloc>()
      ...
      bottom: TabBar(
        tabs: [
          Tab(
            child: Text(
              '${context.translations.conferenceVocabulary.juniorTrack}\n'
          ...
          Tab(
            child: Text(
              '${context.translations.conferenceVocabulary.seniorTrack}\n'
